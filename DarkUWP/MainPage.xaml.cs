...
namespace DarkUWP
{
	...
	public sealed partial class MainPage : Page
	{
		...
		private static string[] characters = new string[]
		{
			...
			" 그러던 어느날, 나는 다섯개의 검은 흉성이 로어 대륙의 강력한 결",
			"계를 뚫고 들어와 그들의 운명속에 스며드는 것을 보았다. 그것들은",
			"정해진 때가 되면 하나씩 그 세계의 운명을 바꾸어 놓을것 같았다.",
			" 그런후에 내가 본것은 아래의 다섯가지였다.",
			"",
			"첫번째 흉성이 나타나는 날,  평화는 로어의 신과 함께 대지로 추락",
			"할 것이며 공간이 어긋나고 대륙이 진동하며  새로운 존재가 나타난",
			"다.",
			"",
			"두번째 흉성이 나타나는 날, 그는 용암의 대륙으로부터 세상을 뒤흔",
			"들게 되며 그는 네크로만서라 불리어 진다.",
			"",
			"세번째 흉성이 나타나는 날, 네크로만서를 이기는 자는 아무도 없게",
			"된다.",
			"",
			"네번째 흉성이 나타나는 날,  메너스의 달이 붉게 물들때 어둠의 영",
			"혼이 나타나 세계의 종말을 예고한다.",
			"",
			"다섯번째 흉성이 나타나는 날,  내가 본 다섯번의 흉성 중에 하나가",
			"나타나지 않았음을 알아 낸다."
		};
	}
}
